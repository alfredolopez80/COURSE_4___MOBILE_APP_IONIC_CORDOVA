...
.controller('MenuController', ['$scope', 'menuFactory','favoriteFactory','baseURL','$ionicListDelegate', 
        ...
        .controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory','favoriteFactory', 'baseURL','$ionicPopover','$ionicListDelegate','$ionicModal','$timeout',
                                        function($scope, $stateParams, menuFactory,favoriteFactory,baseURL,$ionicPopover,$ionicListDelegate,$ionicModal,$timeout) {
            ...
            //comment form modal code beginning

    //START OF COMMENT MODAL CODE        
    $scope.mycomment = {};
